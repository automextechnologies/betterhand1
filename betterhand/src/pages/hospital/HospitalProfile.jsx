    ...
    <div className="max-w-2xl space-y-6 animate-fade-in">
      <div>
        <h1 className="section-title flex items-center gap-2">
          <Building size={22} className="text-brand-600"/> Hospital Profile
        </h1>
        <p className="text-ink-400 text-sm mt-0.5">Update your hospital details and location</p>
      </div>
      ...
      <div className="card p-5 flex items-center justify-between gap-4">
        <div>
          <p className=" font-semibold text-ink-900 flex items-center gap-2">
            <MapPin size={16} className="text-brand-600"/> GPS Location
          </p>
