...
class BloodRequestCreateSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'ward_contact_person', 'ward_contact_phone',
            ...
            # Settings
            'search_radius_km', 'notify_ward_members', 'ward_member_message',
        ]
...
class DonationResponseDonorViewSerializer(serializers.ModelSerializer):
    ...
    bystander_name    = serializers.CharField(source='request.bystander_name', read_only=True, default='')
    bystander_phone   = serializers.CharField(source='request.bystander_phone', read_only=True, default='')
    ...
    class Meta:
        ...
        fields = [
            ...
            'bystander_name', 'bystander_phone',
    ...
    def get_via_ward(self, obj):
        return self._alert(obj) is not None

    def get_ward_member_name(self, obj):
        a = self._alert(obj); return a.ward_member.full_name if a else None

    def get_ward_member_phone(self, obj):
        a = self._alert(obj); return a.ward_member.phone if a else None
