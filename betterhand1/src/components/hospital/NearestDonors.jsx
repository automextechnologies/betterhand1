          ...
          <div className="space-y-2 max-h-96 overflow-y-auto scrollbar-thin pr-1">
            {donors.map((d, i) => (
              <div key={d.id || i}
                ...
                {/* Blood group */}
                <div className="w-10 h-10 rounded-xl bg-blood flex items-center justify-center font-mono font-bold text-danger-300 text-sm shrink-0">
                  {d.blood_group}
                </div>
                {/* Info */}
                ...
                <div className="flex gap-1.5 shrink-0">
                  ...
                  {d.whatsapp_number && (
                    <a href={whatsappLink(d.whatsapp_number)} target="_blank" rel="noreferrer" title="WhatsApp donor"
                      className="w-8 h-8 rounded-lg bg-accent-600/20 text-accent-400 hover:bg-accent-600/30 flex items-center justify-center transition-colors">
