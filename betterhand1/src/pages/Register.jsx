...
const ROLES = [
  ...
  { id:'ward_member', label:'🏛️ Ward Member',  desc:'Govt. coordinator' },
]
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-xl">
        ...
        <div className={`flex items-center gap-2 p-3 rounded-xl mb-4 border text-xs
          ${gpsStatus==='got' ? 'bg-accent-50 border-green-200 text-green-600'
            : gpsStatus==='failed' ? 'bg-warm-50 border-yellow-600/20 text-warm-600'
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="card p-6 space-y-4">
          ...
          {role === 'ward_member' && (<>
            ...
            <div className="p-3 rounded-xl bg-brand-50 border border-brand-200">
              <p className="text-xs text-brand-600/80">ℹ️ Await admin verification before receiving blood alerts.</p>
            </div>
          </>)}
